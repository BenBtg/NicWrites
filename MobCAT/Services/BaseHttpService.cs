...
namespace Microsoft.MobCAT.Services
{
    ...
    public class BaseHttpService
    {
        ...
        /// <param name="deserializeResponse">Indicates whether the reponse should be deserialized or returned directly.</param>
        /// <typeparam name="T">The type of response.</typeparam>
        protected async Task<T> SendAndDeserialize<T>(HttpMethod requestType, string requestUri, CancellationToken cancellationToken = default(CancellationToken), Action<HttpRequestMessage> modifyRequest = null, string requestContent = null, bool deserializeResponse = false)
        {
            T result = default(T);
